...
| [`Ninja12749; Granveyra, Paradox Champion.json`](Ninja12749%3B%20Granveyra%2C%20Paradox%20Champion.json) | **2 fichas** (fonte PXC, tag `paradox`): boss lendária **CR 25** de duas fases, inspirada na Granberia — a espadachim meio-dragão (*Vaporising Rebellion Sword*, *World-Ending Slash* com Morte/Corrupção, *Cut Through Reality*) que, ao cair, **ascende para a forma Conjuradora** (todos os golpes + magia de alto nível, entra pré-buffada com Aid/Haste/Fire Shield/Mirror Image/Stoneskin) |
