...
| Arquivo | O que é |
|---|---|
| ⭐ [`Ninja12749; Bonfire Paradox - Os Verdadeiros Viloes de Gaia.json`](Ninja12749%3B%20Bonfire%20Paradox%20-%20Os%20Verdadeiros%20Viloes%20de%20Gaia.json) | **TODAS as 37 criaturas num só arquivo**, agora sob a **fonte única `VPX`** (do CR 1 ao 30) — toda a coleção aparece com a mesma sigla no Roll20/5e.tools. Importe só este e o bestiário inteiro do Paradoxo de Gaia aparece de uma vez. Use **ESTE _ou_ os arquivos separados abaixo** — não os dois juntos (evita conflito de fontes duplicadas) |
