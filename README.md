...
| Arquivo | O que é |
|---|---|
| ⭐ [`Ninja12749; Bonfire Paradox - Os Verdadeiros Viloes de Gaia.json`](Ninja12749%3B%20Bonfire%20Paradox%20-%20Os%20Verdadeiros%20Viloes%20de%20Gaia.json) | **TODAS as 52 criaturas num só arquivo** (inclui os sets oneshot do Sawjaw Rex e da Aureli), sob a **fonte única `VPX`** (do CR 1 ao 30) — toda a coleção aparece com a mesma sigla no Roll20/5e.tools. Importe só este e o bestiário inteiro do Paradoxo de Gaia aparece de uma vez. Use **ESTE _ou_ os arquivos separados abaixo** — não os dois juntos (evita conflito de fontes duplicadas) |
...
| [`Ninja12749; Master Paradox Kitsune.json`](Ninja12749%3B%20Master%20Paradox%20Kitsune.json) | **2 fichas** (fonte PXK, tag `paradox`): **Tamamo**, a raposa-mestra dos elementos — full caster lendária mais forte que um lich, com os quatro grandes espíritos (Salamander/Undine/Sylph/Gnome), gravidade e meteoros. Começa **Pequena CR 24** e, pela mesma mecânica de renascimento, **ascende para a forma verdadeira Média CR 27** (à vontade: *fireball*/*lightning bolt*; 8º–9º: *meteor swarm*, *earthquake*, *reverse gravity*) |
...
| [`Ninja12749; Paradox Succubus.json`](Ninja12749%3B%20Paradox%20Succubus.json) | **1 ficha** (fonte PXS, tag `paradox`): **Seraviel, a Paradox Succubus** — uma súcubo/íncubo que virou **mestra monge da Palma Aberta**, com a ficha completa de Succubus + Incubus (Charm, Draining Kiss, Etherealness, Shapechanger) por cima de um kit de monge: 5 golpes/turno (1d12 + radiante + necrótico, uma palma sagrada / outra ínfera) e a **Annihilation Palm** — golpe automático estilo Granveyra (72 de energia + a mesma curse/Morte d100 + save de Força ou arremesso de 30 m + prone). CA 21, esquiva por reação, **Diamond Soul**. Boss de **2 fases** (CR 21 → ao morrer ascende para a forma Unbound CR 23) para 4 PCs nível 17 com itens lendários |
| [`Ninja12749; Galaxy Slime Lord.json`](Ninja12749%3B%20Galaxy%20Slime%20Lord.json) | **3 fichas** (fonte GXS, tag `paradox`): **Caelum, The Galaxy Slime** — uma gosma com galáxias dentro (portais aos planos elementais Fogo/Raio/Terra/Ácido), com **mecânica de hidra**. Boss de **2 fases**: *Galaxy Slimeling* (Ooze Pequeno CR 9) → ao morrer **Erupts** na *Galaxy Swarm Lord* (Ooze **Gargantuan** CR 17), que **brota** *Elemental Galaxy Slimes* (CR 4) no mapa (Mitosis: corte e nascem mais — **a menos que Frio/Força/Radiante**). Engole/sufoca (restrained), **dissolve Força** (*wall of force*/*shield*). Para 4 PCs nível 15 (guerreiro echo knight / mago evocação / clérigo da vida / caçador à distância) |
...
| [`campanha/lordes/Kitsune-Tsunari.pt-BR.md`](campanha/lordes/Kitsune-Tsunari.pt-BR.md) | **Tamamo, a Master Paradox Kitsune** — cultiva o caos desmatando/envenenando **Tsunari** |
...
| [`campanha/lordes/Paradox-Succubus.pt-BR.md`](campanha/lordes/Paradox-Succubus.pt-BR.md) | **Seraviel, a Paradox Succubus** — cria do plano onírico que quer ser livre da própria natureza |
| [`campanha/lordes/Galaxy-Slime.pt-BR.md`](campanha/lordes/Galaxy-Slime.pt-BR.md) | **Caelum, a Galaxy Slime** — maou que precisa se propagar pra não enlouquecer como o Vorthrax |
