...
| Arquivo | O que é |
|---|---|
| ⭐ [`Ninja12749; Bonfire Paradox - Os Verdadeiros Viloes de Gaia.json`](Ninja12749%3B%20Bonfire%20Paradox%20-%20Os%20Verdadeiros%20Viloes%20de%20Gaia.json) | **TODAS as 48 criaturas num só arquivo** (inclui os sets oneshot do Sawjaw Rex e da Aureli), sob a **fonte única `VPX`** (do CR 1 ao 30) — toda a coleção aparece com a mesma sigla no Roll20/5e.tools. Importe só este e o bestiário inteiro do Paradoxo de Gaia aparece de uma vez. Use **ESTE _ou_ os arquivos separados abaixo** — não os dois juntos (evita conflito de fontes duplicadas) |
...
| [`Ninja12749; Paradox Succubus.json`](Ninja12749%3B%20Paradox%20Succubus.json) | **1 ficha** (fonte PXS, tag `paradox`): **Paradox Succubus** — uma súcubo/íncubo que virou **mestra monge da Palma Aberta**, com a ficha completa de Succubus + Incubus (Charm, Draining Kiss, Etherealness, Shapechanger) por cima de um kit de monge: 5 golpes/turno (1d12 + radiante + necrótico, uma palma sagrada / outra ínfera) e a **Annihilation Palm** — golpe automático estilo Granveyra (72 de energia + a mesma curse/Morte d100 + save de Força ou arremesso de 30 m + prone). CA 21, esquiva por reação, **Diamond Soul**. Boss solo **CR 21** para 4 PCs nível 17 com itens lendários |
